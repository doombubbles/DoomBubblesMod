...
{
    public class Bane : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dust1 = Dust.NewDust(new Vector2(projectile.position.X - projectile.velocity.X * 4f + 2f, projectile.position.Y + 2f - projectile.velocity.Y * 4f), 8, 8, 57, projectile.oldVelocity.X, projectile.oldVelocity.Y, 5, default(Color), 1.25f);
                Main.dust[dust1].velocity *= -0.25f;
                Main.dust[dust1].noGravity = true;
                int dust2 = Dust.NewDust(new Vector2(projectile.position.X - projectile.velocity.X * 3f + 2f, projectile.position.Y + 2f - projectile.velocity.Y * 3f), 8, 8, 57, projectile.oldVelocity.X, projectile.oldVelocity.Y, 5, default(Color), 1.25f);

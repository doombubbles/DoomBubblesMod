    ...
    public abstract class LunarBullet : ModProjectile
    {
        ...
        public void SolarEffect(ref int damage)
        {
                ...
                Searches.Chain(new Searches.Down(12), new Conditions.IsSolid()), out var _))
            {
                ...
                {
                    var dust = Dust.NewDust(Projectile.Center, 0, 0, ModContent.DustType<Solar229>(), (float) Math.Cos(theta),
        ...
        public void VortexEffect(NPC target)
        {
            ...
            var proj = Projectile.NewProjectile(new ProjectileSource_ProjectileParent(Projectile), pos, v, ModContent.ProjectileType<VortexBullet2>(),
        ...
        public void StardustEffect(NPC target)
        {
            ...
            Projectile.NewProjectile(new ProjectileSource_ProjectileParent(Projectile), newPos, Projectile.oldVelocity.RotatedByRandom(Math.PI / 15) / 2,

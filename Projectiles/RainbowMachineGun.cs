            ...
            if (flag && Main.myPlayer == Projectile.owner)
            {
                    ...
                    !player.noItems && !player.CCed)
                {
                    ...
                    for (var j = 0; j < 2; j++)
                    {
                        ...
                        var proj = Projectile.NewProjectile(new ProjectileSource_ProjectileParent(Projectile), vector2.X, vector2.Y, spinningpoint2.X, spinningpoint2.Y,
                            ModContent.ProjectileType<Rainbow>(), Projectile.damage, Projectile.knockBack, Projectile.owner);

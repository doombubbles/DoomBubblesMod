...
namespace DoomBubblesMod.Projectiles
{
    public class ManapireKnife : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("ManapireRestore"), 0, 0f, projectile.owner, projectile.owner, damage);
            }
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num402 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, mod.DustType("ManapireDust"), 0f, 0f, 100, default(Color), 0.8f);

...
public class CustomPacketByte<T> : CustomPacketDelegate<T, byte> where T : CustomPacket<T>
{
...
public class CustomPacketBool<T> : CustomPacketDelegate<T, bool> where T : CustomPacket<T>
{
...
public class CustomPacketShort<T> : CustomPacketDelegate<T, short> where T : CustomPacket<T>
{
...
public class CustomPacketInt<T> : CustomPacketDelegate<T, int> where T : CustomPacket<T>
{
...
public class CustomPacketLong<T> : CustomPacketDelegate<T, long> where T : CustomPacket<T>
{
...
public class CustomPacketString<T> : CustomPacketDelegate<T, string> where T : CustomPacket<T>
{
...
public class CustomPacketChar<T> : CustomPacketDelegate<T, char> where T : CustomPacket<T>
{
...
public class CustomPacketPlayer<T> : CustomPacketDelegate<T, Player> where T : CustomPacket<T>
{
...
public class CustomPacketNPC<T> : CustomPacketDelegate<T, NPC> where T : CustomPacket<T>
{
...
public class CustomPacketProjectile<T> : CustomPacketDelegate<T, Projectile> where T : CustomPacket<T>
{
